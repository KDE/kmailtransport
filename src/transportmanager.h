...
public:
    ...
    */
    ...
    /*!
      ...
      \a id The identifier of the Transport.
      \a def if set to true, the default transport will be returned if the
    ...
    */
    ...
    /*!
      ...
      or transport name.
      Returns 0 if the specified transport is invalid.
      \a transport A string defining a mail transport.
    ...
    */
    ...
    /*!
      ...
      \a job The completely configured transport job to execute.
    ...
    */
    ...
    /*!
      ...
      \a parent Parent widget of the dialog.
      \a showCondition the condition under which the dialog is shown at all
      Returns True if a new transport has been created and configured.
      \since 4.4
    */
    ...
    /*!
      ...
      \a identifier The identifier.
      \a transport The transport to configure.  It can be a new transport,
...
Q_SIGNALS:
    ...
    */
    ...
    /*!
      ...
      \a id The identifier of the deleted transport.
      \a name The name of the deleted transport.
    */
    void transportRemoved(int id, const QString &name);

    /*!
      Emitted when a transport has been renamed.
      \a id The identifier of the renamed transport.
      \a oldName The old name.
      \a newName The new name.
    */
